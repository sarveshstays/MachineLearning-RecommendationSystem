...
class Popularity_Recommender():
	...
	def create(self,train_data,user_id,item_id, rating_id):
		...
		train_data_grouped = train_data.groupby([self.item_id,self.rating_id]).agg({self.user_id: 'count'}).reset_index()
